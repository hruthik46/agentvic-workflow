...
_TEMPLATES = {
    'ARCH-DESIGN': {
        ...
        'steps': [
            ...
            'bash: agent msg send orchestrator "[ARCH-COMPLETE] {gid} iteration {it}"  # do NOT use agent send (wrong) — use agent msg send',
        ],
        'tail_schema': None,
        'rules': [
    ...
    'ARCH-BLIND-REVIEW': {
        ...
        'steps': [
            ...
            'bash: agent msg send orchestrator "[ARCH-REVIEWED] {gid} iteration {it}"  # dispatcher reads review.json from disk — do NOT pipe JSON',
        ],
    ...
    'E2E-REVIEW': {
        ...
        'steps': [
            ...
            'bash: agent msg send orchestrator "[E2E-RESULTS] {gid} iteration {it}"  # dispatcher reads e2e-results.json from disk',
        ],
    ...
    'TEST-RUN': {
        ...
        'steps': [
            ...
            'bash: agent msg send orchestrator "[TEST-RESULTS] {gid} iteration {it}"  # dispatcher reads test-results.json from disk',
        ],
        'tail_schema': None,
        'rules': [
